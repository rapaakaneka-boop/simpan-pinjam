        ...
        <div className="min-h-screen bg-slate-50 px-6 py-8 text-slate-900">
            <div className="mx-auto max-w-6xl space-y-8">
                <header className="mb-8">
                    <h2 className="text-2xl font-bold text-slate-900">Pre-Loan Checking</h2>
                    <p className="mt-2 text-slate-500">Cek kelayakan awal sebelum pengajuan.</p>
                </header>

                <div className="rounded-xl border border-slate-100 bg-white p-8 shadow-sm">
                    <p className="text-slate-700">
                        Halaman ini akan membantu mengevaluasi kelayakan nasabah sebelum memproses pengajuan.
                    </p>
                    <div className="mt-6">
                        <Link
                            href="/pinjaman"
